        ...
        {projects.map((project) => (
          ...
          >
            ...
            <div className=" flex flex-col flex-grow p-4">
              ...
              <div className="flex justify-between items-end mr-2 gap-4 h-[4rem] mt-auto">
                {project.url ? (
                  <a
                    href={project.url}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:text-primary hover:opacity-95 text-muted-foreground hover:underline flex items-center justify-center gap-1 sm:gap-2"
                  >
                ...
                {project.github_url && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-primary p-2 rounded-md border hover:bg-accent transition-all"
                  >
                    <span className="sr-only">Github</span>
                    <Github className="h-[1.25rem] w-[1.25rem] opacity-90"></Github>
                  </a>
                )}
              </div>
            </div>
